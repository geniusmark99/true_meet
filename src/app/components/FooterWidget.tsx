...
const FooterWidget = () => {
    ...
    return <>
        ...
        <footer className="mt-auto w-full  py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-white border-t  border-emerald-600">
            <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
                <div>
                    <Link
                        className="flex-none text-xl font-semibold text-clip bg-clip-text text-transparent bg-linear-120 from-emerald-500 to-green-600 focus:outline-hidden"
                        href="/"
                        aria-label="Brand"
                    >
                        True Meet
                ...
                <ul className="text-center">
                    {["About", "Services", "Blog"].map((item) => (
                        ...
                        >
                            <Link
                                href="/"
                                className="inline-flex gap-x-2 text-sm text-gray-500 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 "
                            >
                                {item}
                            </Link>
                        </li>
