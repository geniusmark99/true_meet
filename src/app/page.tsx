  ...
  return <>
    <div>
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-950/80 via-transparent to-emerald-700/80" />
        <div className="absolute inset-0 bg-opacity-50" />
        <div className="relative z-10 px-6 flex flex-col lg:flex-row w-full h-auto lg:h-screen">
          ...
          <div className="w-full lg:w-6/12 flex justify-center items-center flex-col space-y-4">
            <h1
              className="text-4xl md:text-5xl text-center max-w-lg lg:text-left font-extrabold bg-gradient-to-r from-white via-green-100 to-gray-100 bg-clip-text text-transparent"
            >Welcome to True meet,Ready to go on a date?</h1>
            {/* <p className="text-2xl text-center lg:text-left mt-4">Your one-stop solution for all your meeting needs.</p> */}

            <div className="mt-6 space-x-4 lg:w-[70%] flex start-0">
          ...
          <div className="w-full lg:w-6/12 relative h-[300px] lg:h-auto"
            style={{
              backgroundImage: "url('./images/hero-lovers.png')",
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          >
